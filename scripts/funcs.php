<?php
    ...
    if($update > $Version) {
        $update_Avail = "<div class=\"callout callout-warning\"><h4>Update Available!</h4><p>Smart Stats has an update. Download it from <a href=\"https://github.com/smartclash/statuspage/releases\" target=\"_blank\">Here</a></div>";
    } else {
		$update_Avail = "";
	}
